...
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра КНБ-MP", "Игра в 21", "Кубик", "Выход"], parent=m_main)
...
m_game_cube = Menu("Кубик", buttons=["Начать", "Выход"], parent=m_games, module="botGames")

m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-45", "Задание-6", "Задание-7n", "Задание-7a", "Задание-8", "Задание-92", "Задание-91", "Задание-10", "Выход"], parent=m_main, module="DZ")

m_fun = Menu("Развлечения", buttons=["Википедия", "Цитата", "Книга", "Поиск по названию", "Поиск по автору", "Число", "Котик", "Собака", "Анекдот", "Фильм", "Выход"], parent=m_main, module="fun")
